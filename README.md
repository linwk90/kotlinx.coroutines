...
[![Download](https://api.bintray.com/packages/kotlin/kotlinx/kotlinx.coroutines/images/download.svg?version=0.24.0-eap13) ](https://bintray.com/kotlin/kotlinx/kotlinx.coroutines/0.24.0-eap13)
...
```groovy
compile 'org.jetbrains.kotlinx:kotlinx-coroutines-android:0.24.0-eap13'
```
